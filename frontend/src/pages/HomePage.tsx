...
interface HomePageProps {
  onCategorySearch?: string | null;
  showFavoritesView?: boolean;
  onResetFavoritesView?: () => void;
}

export default function HomePage({ onCategorySearch, showFavoritesView, onResetFavoritesView }: HomePageProps) {
